...
/**
 * Created by lf on 2020/10/29 12:09.
 */
public abstract class MyBaseNCodec implements MyBinaryEncoder, MyBinaryDecoder {
    ...
    public Object decode(Object obj) throws MyDecoderException {
        if (obj instanceof byte[]) {
            return this.decode(obj);
        } else if (obj instanceof String) {
            return this.decode((String) obj);
        } else {
            throw new MyDecoderException("Parameter supplied to Base-N decode is not a byte[] or a String");
        }
    }
