...
/**
 * Created by lf on 2020/10/29 12:18.
 */
public class MyStringUtils {
    ...
    public static String newStringIso8859_1(byte[] bytes) {
        return new String(bytes, MyCharsets.ISO_8859_1);
    }

    public static String newStringUsAscii(byte[] bytes) {
        return new String(bytes, MyCharsets.US_ASCII);
    }

    public static String newStringUtf16(byte[] bytes) {
        return new String(bytes, MyCharsets.UTF_16);
    }

    public static String newStringUtf16Be(byte[] bytes) {
        return new String(bytes, MyCharsets.UTF_16BE);
    }

    public static String newStringUtf16Le(byte[] bytes) {
        return new String(bytes, MyCharsets.UTF_16LE);
    }
